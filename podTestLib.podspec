...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/luckyarthur/podTestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '李扬' => 'ly26@meitu.com' }
  s.source           = { :git => 'https://github.com/luckyarthur/podTestLib.git', :tag => s.version.to_s }
